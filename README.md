...
<ol>
  ...
  <li>Arduino pins 8–11 → relay inputs</li>
  <li>Provide 5V & GND</li>
  <li>Run Python gesture script</li>
  <li>Upload Arduino code</li>
  <li>Test gesture control</li>
  <li>Setup ESP8266 with Sinric Pro</li>
  <li>Add API keys</li>
  <li>Connect to 2.4GHz WiFi</li>
</ol>
